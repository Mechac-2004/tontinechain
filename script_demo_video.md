...
**[Action : Cliquez sur le bouton bleu "Cotiser" pour deux membres]**
"À chaque cotisation reçue, le bouton bleu devient un badge vert **PAYÉ** avec une icône de validation. Notre graphique **Chart.js** se met à jour instantanément pour montrer la progression de la collecte. Regardez le journal de bord : chaque transaction est enregistrée avec son horodatage, créant une piste d'audit immuable."

## 🔓 Étape 4 : Libération des Fonds (3:30 - 4:15)
**[Action : Cliquez sur "Cotiser" pour le dernier membre. Le bouton vert de libération apparaît]**
...
*   **Couleurs** : Notez bien que le passage du **Bleu (Action)** au **Vert (Succès)** est un point fort visuel à mentionner.
*   **Visuels** : Montrez bien les mouvements du graphique et les mises à jour des logs.
